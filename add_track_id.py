...
songs = pd.read_csv("/Users/kade/LocalDocs/G.csv")
...
obj = {}
cnt = 0
for root, dirs, files in os.walk(os.path.normpath('/Volumes/TIME/msd-zip/G')):
...
output.to_csv("/Users/kade/LocalDocs/G-enhanced.csv")
