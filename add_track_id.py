...
songs = pd.read_csv("/Users/kade/LocalDocs/I.csv")
...
obj = {}
cnt = 0
for root, dirs, files in os.walk(os.path.normpath('/Users/kade/LocalDocs/I')):
...
output.to_csv("/Users/kade/LocalDocs/I-enhanced.csv")
