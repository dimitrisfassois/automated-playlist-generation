...
songs = pd.read_csv("/Users/kade/LocalDocs/N.csv")
...
obj = {}
cnt = 0
for root, dirs, files in os.walk(os.path.normpath('/Volumes/TIME/msd-zip/N')):
...
output.to_csv("/Users/kade/LocalDocs/N-enhanced.csv")
