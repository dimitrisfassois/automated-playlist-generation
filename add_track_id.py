...
songs = pd.read_csv("/Users/kade/LocalDocs/E.csv")
...
obj = {}
cnt = 0
for root, dirs, files in os.walk(os.path.normpath('/Volumes/TIME/msd-zip/E')):
...
output.to_csv("/Users/kade/LocalDocs/E-enhanced.csv")
